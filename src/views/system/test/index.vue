<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编码" align="center" prop="testCode"  />
      <el-table-column label="内容" align="center" prop="testContent"  />
      <el-table-column label="时间" align="center" prop="testDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.testDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="价格" align="center" prop="testPrice"  />
      <el-table-column label="状态" align="center" prop="testStatus"  />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="编码" prop="testCode">
          <el-input v-model="form.testCode" placeholder="请输入编码" />
        </el-form-item>
        <el-form-item label="内容">
          <editor v-model="form.testContent" :min-height="192"/>
        </el-form-item>
        <el-form-item label="时间" prop="testDate">
          <el-date-picker clearable size="small"
